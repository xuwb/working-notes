...
define(function (require, exports, module) {
    ...
    var Paginator = Widget.extend({
        ...
        events: {
            ...
            //焦点点击
            'click .JS-click-active': function clickJSClickActive(e) {
                var me = this,
            ...
            'change .JS-select-size': function changeJSSelectSize(e) {
                var me = this,
                    select = e.target,
        ...
        //更新数据
        paginatorRenderData: function paginatorRenderData() {
            var me = this,
                totle = me.get('totle'),
                sizeList = me.get('sizeList'),
        ...
        //渲染DOM
        paginatorRender: function paginatorRender() {
            var me = this;
            //初始化模板
        ...
        //上一个下一个
        paginatorPrevNext: function paginatorPrevNext(e) {
        ...
        paginatorJump: function paginatorJump(index, e) {
            var me = this;
        ...
        // 绑定页面跳转事件
        paginatorEventJump: function paginatorEventJump() {
            var me = this,
                element = me.element;
        ...
        //重置
        paginatorReload: function paginatorReload(config) {
            var me = this;
            //重置
        ...
        Statics: {
            getSize: function getSize(size, sizeList) {
                var pageSize = size;
