...
define(function (require, exports, module) {
  ...
  var Widget = Base.extend({
    ...
    _parseDataAttrsConfig: function _parseDataAttrsConfig(config) {
    ...
    // 注册事件代理
    delegateEvents: function delegateEvents(element, events, handler) {
      ...
      for (var key in events) {
        ...
        var selector = args.selector;(function (handler, widget) {
    ...
    // 卸载事件代理
    undelegateEvents: function undelegateEvents(element, eventKey) {
      var argus = trimRightUndefine(Array.prototype.slice.call(arguments));
    ...
    _renderAndBindAttrs: function _renderAndBindAttrs() {
      var widget = this;
    ...
    _onRenderId: function _onRenderId(val) {
      this.element.attr('id', val);
    },

    _onRenderClassName: function _onRenderClassName(val) {
      this.element.addClass(val);
    },

    _onRenderStyle: function _onRenderStyle(val) {
      this.element.css(val);
    },

    // 让 element 与 Widget 实例建立关联
    _stamp: function _stamp() {
      var cid = this.cid;(this.initElement || this.element).attr(DATA_WIDGET_CID, cid);
  ...
  var contains = $.contains || function (a, b) {
    //noinspection JSBitwiseOperatorUsage b在a内返回16，即10000。其他返回值和16与均返回0
