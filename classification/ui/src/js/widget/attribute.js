...
define(function(require, exports, module){
  ...
  exports.initAttrs = function(config) {
    ...
    // Get all inherited attributes.  propsInAttrs将特殊属性名保存到数组中
    var specialProps = this.propsInAttrs || [];
	// 将this.construction.prototype包含 specialProps属性名的属性，赋值到this.construction.prototype.attrs中添加 
  ...
  function mergeInheritedAttrs(attrs, instance, specialProps) {
    ...
    while (proto) {
      // instance 的 prototype上没有 attrs 的话，添加attrs属性
  ...
  // specialProps 为数组保存特殊的属性名，将supplier中包含的specialProps，赋值给receiver
